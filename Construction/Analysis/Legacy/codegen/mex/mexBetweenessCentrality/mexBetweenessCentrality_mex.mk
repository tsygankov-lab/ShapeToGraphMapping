START_DIR = A:\delta\OneDrive\Graduate School\FORTUN~3\PREPOS~1

MATLAB_ROOT = A:\MATLAB~2
MAKEFILE = mexBetweenessCentrality_mex.mk

include mexBetweenessCentrality_mex.mki


SRC_FILES =  \
	mexBetweenessCentrality_data.c \
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\mexBetweenessCentrality"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\mexBetweenessCentrality/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
