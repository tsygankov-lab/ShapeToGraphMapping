%%Have to implement getBorderRads to get pairs of edges...
%%...
function plotBoundary_ColorByBoundaryProfile(records, loopStruct)
radList = {};
boundVertexCoor = {};
maxMeanRad = [];
maxMinRad = [];
...
% end
boundVertexCoor = loopStruct.boundaryVertexCoor;
boundaryProf = loopStruct.boundaryDiff;
